...
const icons = {
    ...
    chart: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>,
    map: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="3 11 22 2 13 21 11 13 3 11"></polygon></svg>,
        ...
        <aside className="sidebar">
            <div className="logo-area">
                <div className="logo-icon">
                    <img src={logoSvg} alt="SkySense Logo" style={{ width: '100%', height: '100%' }} />
                </div>
            </div>
            ...
            <div className="sidebar-footer" style={{ marginTop: 'auto', marginBottom: '1rem' }}>
                <div
